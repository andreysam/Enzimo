  ...
  return (
    <div className="doctor-element">
      ...
      <div  className="doctor-element-text">
        ...
        <div className="docot-element-desc">{props.doctor.desc}</div>
      </div>
    </div>
  )
}
...
const app = (
  <div className="app">
    ...
    <div className="disease-list">
      ...
      <Disease disease={{ name: "Последствия травм", img: "img/disease/injury.svg", color:"linear-gradient(301.3deg, rgba(53, 173, 156, 0.5) 36.46%, rgba(92, 199, 183, 0.5) 74.37%)"}}/>        <Disease disease={{ name: "Проблемы с сердцем", img: "img/disease/heart2 1.svg", color:" linear-gradient(299.96deg, rgba(219, 103, 142, 0.5) 47.21%, rgba(232, 148, 176, 0.5) 76.12%)"}}/>
     ...
     <div>
     <div class="clinics-head">КЛИНИКИ</div>
